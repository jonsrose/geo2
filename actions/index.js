...
export function mapCenterChanged(latitude, longitude) {
  return {
...
export function mapTypeIdChanged(mapTypeId) {
  return {
    type: MAP_TYPE_ID_CHANGED,
    mapTypeId
  }
}
